          ...
          <div class="customer-task-content">
            ...
            <div class="customer-task-header">
              <div class="rewards_card b_border">
                <div class="reward-item d_flex" v-if="customerInfo.type==1">
                  <router-link to="/customertask/promotiondetail" class="item-money">Rewards of this month {{customerInfo && customerInfo.ap && apInfo.money/100 | moneyFormat}}</router-link>
                ...
                <div v-else>
                  <div class="reward-item reward-item-first">
                    <div class="item-title d_flex_between d_flex">
                      ...
                      <router-link to="/customertask/promotiondetail" class="item-link color_active d_flex">
                  ...
                  <div class="reward-item">
                    <div class="item-title d_flex_between d_flex">
                      ...
                      <div class="item-link color_active d_flex">
                        <van-tag type="warning">Part time</van-tag>
                      </div>
                    </div>
            ...
            <div class="reward-link-content bg_white">
              ...
              <div class="link-intro">
                ...
                <section v-if="customerInfo.type!=1">and complete <strong>Todo 1</strong>, <strong>Todo 2</strong> tasks</section>
                , you can get rewards.
              </div>
              <div class="link-operate ">
                <div class="link-view link-view-color" v-if="customerInfo.type!==1">
                  <router-link to="/customertask/promotioninfo">View Tasks</router-link>
                </div>
                <div class="d_flex" v-else>
                  <div class="link-view link-view-color">
                    <router-link to="/customertask/promotioninfo">Rewards standard</router-link>
                  </div>
                  <div class="link-view link-tools-color">
                    <router-link to="/customertask/promotiontool">
                      Marketing tools
                    </router-link>
                  </div>
                </div>
