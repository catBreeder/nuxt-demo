  ...
  <div class="cost-wrapper">
    <scroll-view class="scrollViewHeight">
      ...
      <div class="result-box">
        <strong>Result : <span class="color_active">{{resultData}}</span> ZAR</strong>
      </div>
    </scroll-view>
    <!--   弹出框-->
    <van-dialog v-model="showCountVisible"  :show-cancel-button="false" :show-confirm-button="false">
      <calculate-popup @closeEmit="showCountVisible = false"/>
    </van-dialog>
...
<script>
  ...
  export default {
    ...
    components:{ScrollView ,CalculatePopup},
    data(){
      return{
