    ...
    <scroll-view class="addressOperateScroll">
      <div class="address-operate-content">
        <div class="form-content">
          <van-notice-bar :scrollable="false" background="#fff" color="#ff7300" wrapable>According to Shipping Laws and Regulations, you must fill the Surname and Forename.</van-notice-bar>
...
<script>
  ...
  export default {
    head(){
      return {
        title:'Orders Transport - shopshipshake'
      }
    },
    computed:{
    ...
    mounted(){
      ...
      this.getEditInfo(this.$route.query.receiverid)
    }
